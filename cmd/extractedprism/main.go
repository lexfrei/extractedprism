...
func registerFlags() {
	...
	flags.String("health-bind-address", "", "address for health server (defaults to --bind-address)")
...
func bindEnvVars() {
	...
	mustBindPFlag("health_bind_address", flags.Lookup("health-bind-address"))
...
func buildConfig() *config.Config {
	...
	cfg.HealthBindAddress = viper.GetString("health_bind_address")
